...
1. Implantar o monólito com Radar e BOTSON desligados.
...
7. Enviar `ligar botson`; parear se necessário.
8. Rodar `testar botson` com uma allowlist de uma Secretaria.
9. Conferir acesso final, Outbox e efeitos em `review`.
10. Ampliar a allowlist apenas depois da homologação.
...
1. Enviar `desligar botson` e `desligar radar`.
